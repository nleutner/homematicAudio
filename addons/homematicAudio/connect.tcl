...
# If argument "<speakername>" is passed, the script will only connect
# the passed speaker, othwersite volume for all speaker will be connected
#
# examples:
# tclsh connect.tcl
...
set url http://$CCURemoteIP:$CCURemotePort/connect
